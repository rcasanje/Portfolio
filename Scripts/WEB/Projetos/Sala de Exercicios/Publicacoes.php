...
<div class="container" id="principal">
  ...
  <?php
    ...
    if(isset($_GET['id'])){
      ...
      printf('
      <div style="margin-top:10px; margin-bottom:10px;"><a href="Publicacoes.php" class="btn btn-primary" role="button">Voltar</a></div>
      <div class="well">
        <h2>%s</h2>
        <p>%s</p>
...
function expandirDiv(num){
	if (expansion[num] == 0){
		...
		document.getElementById("btnconteudo"+num).innerHTML = "Retrair texto";
    	//console.log("Crescendo");
  	} else {
    	expansion[num] = 0;
    	$("#conteudo"+num).hide(tempoms);
		document.getElementById("btnconteudo"+num).innerHTML = "Expandir texto";
